...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employee', function (Blueprint $table) {
            ...
            $table->string('alamat_kode_pos_employee', 75);
            $table->string('jabatan_employee', 100);
            $table->string('agama_employee', 50);
            $table->string('phone_employee', 14);
            $table->string('email_employee', 14);
            $table->unsignedBigInteger('id_grade', false);
            $table->timestamp('tanggal_masuk_employee')->nullable();
            $table->string('tempat_lahir_employee', 50);
            $table->timestamp('tanggal_lahir_employee')->nullable();
            $table->enum('jenis_kelamin_employee', ['laki-laki', 'perempuan']);
            $table->enum('status_employee', ['pkwt', 'pkwtt', 'resign']);
            $table->timestamp('masa_kontrak_awal')->nullable();
            $table->timestamp('masa_kontrak_akhir')->nullable();
            ...
            $table->string('nama_ibu_employee', 100);
