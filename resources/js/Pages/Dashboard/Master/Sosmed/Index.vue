<template>
    <div class="p-3 rounded-xl bg-white flex flex-col gap-4">
        <!-- Title Pages -->
        <title-pages> Social Media </title-pages>
        <!-- Endt Title Pages -->
        <!-- Mesasge -->
        <div
            ...
            >
                <div class="h-32 overflow-hidden">
                    <img
                        ...
                        :src="'/storage/img/sosmed/' + blogNews.image"
                        alt=""
                    />
                </div>
                <div
            ...
            >
                <div class="mx-auto w-2/4 bg-white drop-shadow-lg rounded-lg">
                    ...
                    >
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-gray-700">Link</label>
                            <input
                                type="text"
                                class="drop-shadow-sm border py-2 px-3 rounded-md focus:outline-none text-sm"
                                v-model="form.link"
                        ...
                        <div v-if="updateMode" class="flex justify-center">
                            ...
                            <div v-else>
                                <img
                                    class="rounded-md max-w-sm mx-auto max-h-60"
                                    :src="'/storage/img/sosmed/' + this.image"
                                    alt=""
                                />
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-gray-700">Images link</label>
                            <input
                                class="text-sm"
                                type="file"
                                @input="
...
export default {
    ...
    methods: {
        ...
        showData(id) {
            ...
            this.form.link = this.singelData[0].link;
        ...
        submitForm() {
            if (!this.updateMode) {
                router.post(
                    "/dashboard/master/sosmed/create-sosmed",
                    this.form,
                    {
                        preserveScroll: true,
                        onSuccess: () => {
                ...
                router.post(
                    "/dashboard/master/sosmed/update-sosmed/" +
        ...
        deleteButton(id) {
            router.delete("/dashboard/master/sosmed/delete-sosmed/" + id, {
                preserveScroll: true,
                onSuccess: () => {
                    this.closedModal();
                },
