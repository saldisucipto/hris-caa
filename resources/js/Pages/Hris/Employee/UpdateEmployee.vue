    ...
    <div class="p-3 rounded-xl bg-white flex flex-col gap-2">
        ...
        <div class="bg-slate-100 rounded-lg">
            <div class="p-3 flex flex-col">
                ...
                <div>
                    <form
                        @submit.prevent="updateDataKaryawan"
                    ...
                    >
                        ...
                        <div class="flex justify-center gap-5">
                            <button
                                class="flex-1 bg-yellow-400 hover:bg-yellow-700 text-white py-1 rounded-md drop-shadow-sm px-3"
                                type="submit"
                            >
...
export default {
    ...
    methods: {
        updateDataKaryawan() {
            ...
            router.post(
                "/hris/karyawan/update-karyawan/" + this.karyawan.id,
                this.form,
                {
                    preserveScroll: true,
                    onSuccess: () => {
        ...
        fillData() {
            this.form.nama_employee = this.karyawan.nama_employee;
            this.form.id_company = this.karyawan.id_company;
            this.form.jabatan_employee = this.karyawan.jabatan_employee;
            this.form.nik_employee = this.karyawan.nik_employee;
            this.form.no_kk_employee = this.karyawan.no_kk_employee;
            this.form.alamat_employee = this.karyawan.alamat_employee;
            this.form.alamat_rt_employee = this.karyawan.alamat_rt_employee;
            this.form.alamat_rw_employee = this.karyawan.alamat_rw_employee;
            this.form.alamat_kode_pos_employee =
                this.karyawan.alamat_kode_pos_employee;
            this.form.alamat_kel_employee = this.karyawan.alamat_kel_employee;
            this.form.alamat_kec_employee = this.karyawan.alamat_kec_employee;
            this.form.alamat_kab_employee = this.karyawan.alamat_kab_employee;
            this.form.alamat_prov_employee = this.karyawan.alamat_prov_employee;
            this.form.agama_employee = this.karyawan.agama_employee;
            this.form.phone_employee = this.karyawan.phone_employee;
            this.form.email_employee = this.karyawan.email_employee;
            this.form.id_grade = this.karyawan.id_grade;
            this.form.tanggal_masuk_employee =
                this.karyawan.tanggal_masuk_employee;
            this.form.jenis_kelamin_employee =
                this.karyawan.jenis_kelamin_employee;
            this.form.tempat_lahir_employee =
                this.karyawan.tempat_lahir_employee;
            this.form.tanggal_lahir_employee = this.formatDate(
                this.karyawan.tanggal_lahir_employee
            );

            this.form.nik_karyawan_employee =
                this.karyawan.nik_karyawan_employee;
            this.form.status_employee = this.karyawan.status_employee;
            this.form.masa_kontrak_awal = this.formatDate(
                this.karyawan.masa_kontrak_awal
            );
            this.form.masa_kontrak_akhir = this.formatDate(
                this.karyawan.masa_kontrak_akhir
            );
            this.form.bpjs_ks_employee = this.karyawan.bpjs_ks_employee;
            this.form.bpjs_tk_employee = this.karyawan.bpjs_tk_employee;
            this.form.npwp_employee = this.karyawan.npwp_employee;
            this.form.npwp_employee = this.karyawan.npwp_employee;
            this.form.id_bank = this.karyawan.id_bank;
            this.form.bank_account_employee =
                this.karyawan.bank_account_employee;
            this.form.nama_ibu_employee = this.karyawan.nama_ibu_employee;
            this.form.jumlah_anak_employee = this.karyawan.jumlah_anak_employee;
            this.form.status_pernikahan_employee =
                this.karyawan.status_pernikahan_employee;
            this.form.last_edu = this.karyawan.last_edu;
        },

        formatDate(dateData) {
            let dateIsoString = new Date(dateData).toISOString().slice(0, 10);
